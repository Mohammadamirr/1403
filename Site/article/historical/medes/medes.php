<?php
// اطلاعات مربوط به متا تگ‌ها جهت بهبود SEO
$title = "دوران مادها و تاثیر آنان در تاریخ ایران";
$description = "مقاله جامع درباره دوران مادها؛ بررسی تاثیرات سیاسی، فرهنگی و اجتماعی آنان در تاریخ ایران و جهان.";
$keywords = "دوران مادها, تاریخ ایران, مادها, تاثیر مادها, تمدن ایرانی";
?>
<?php
...
<body>
  ...
  <script>
    // اسکریپت جاوااسکریپت برای اعلام پایان مطالعه
    window.addEventListener('scroll', function() {
      var scrollHeight = document.documentElement.scrollHeight;
      var scrolled = window.scrollY + window.innerHeight;

      // وقتی کاربر به پایین صفحه می‌رسد (با افزودن کمی دقت در محاسبه)
      if (scrolled >= scrollHeight - 5) {
        alert("از مطالعه‌ی کامل این مقاله سپاسگزاریم!");
      }
    });
  </script>
</body>
